...
const Banner = () => {
  ...
  return (
    <div
      ...
      className="md:col-span-3 col-span-4 md:order-2 order-1"
    >
      <Swiper
        spaceBetween={30}
        loop={true}
      ...
      >
        {bannersData[0]?.banners?.map((image) => (
          <SwiperSlide key={image.image_id}>
            <img className="md:h-[420px] w-full" src={image.image_url} alt="" />
          </SwiperSlide>
        ))}

        <div
          className="autoplay-progress w-8 h-8 md:w-12 md:h-12"
          slot="container-end"
        >
